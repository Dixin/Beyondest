...
tit=vbcrlf & "<a href='?'>壁纸管理</a>&nbsp;┋&nbsp;" & _
    vbcrlf & "<a href='?action=add&types="&nsort&"'>添加壁纸</a>&nbsp;┋&nbsp;" & _
    vbcrlf & "<a href='admin_nsort.asp?nsort=paste'>壁纸分类</a>"
...
<option value='paste'<%if types="paste" then response.write " selected"%>>壁纸</option>
...
<a href='?types=paste'<%if types="paste" then response.write " class=red_3"%>>壁纸</a><br>
