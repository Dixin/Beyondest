...
tit=vbcrlf & "<a href='?'>照片管理</a>&nbsp;┋&nbsp;" & _
    vbcrlf & "<a href='?action=add&types="&nsort&"'>添加照片</a>&nbsp;┋&nbsp;" & _
    vbcrlf & "<a href='admin_nsort.asp?nsort=baner'>照片分类</a>"
...
<option value='baner'<%if types="baner" then response.write " selected"%>>照片</option>
...
<a href='?types=baner'<%if types="baner" then response.write " class=red_3"%>>照片</a><br>
